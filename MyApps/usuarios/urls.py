...
from MyApps.usuarios.views import DocenteList, DocenteDetail, EstudianteList, EstudianteDetail, EstudianteLoginView, TutorList, TutorDetail, HorarioDisponibilidadList, HorarioDisponibilidadDetail
